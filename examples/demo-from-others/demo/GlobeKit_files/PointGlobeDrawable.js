...
GK.PointGlobeDrawable = function(){
    ...
    this.init = function() {
        ...
        texture = GK.TextureManager.loadTexture("/img/dot.png", true, gl.CLAMP_TO_EDGE, gl.CLAMP_TO_EDGE);
        noiseTexture = GK.TextureManager.loadTexture("/img/clouds.png", true, gl.REPEAT, gl.REPEAT);
        return this;
    }
